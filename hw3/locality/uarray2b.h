 ...
 * locality
 *
 * uarray2b.h declares the function headers for the uarray2b class.
 * 
 * All functions are public and can be used externally.
 */
...
void map_blocks(int col, int row, T array2b, void *elem, void *cl);
/*
